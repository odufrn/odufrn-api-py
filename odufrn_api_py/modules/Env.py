...
class Env(ABC):
    def __init__(self, client_id, client_secret, x_api_key, version):
        ...
        self.warnings = False # não utilizado ainda
        ...
        autenticacao = ('authz-server/oauth/token?client_id={0}' +
                        '&client_secret={1}&grant_type=client_credentials').format(client_id, client_secret)
